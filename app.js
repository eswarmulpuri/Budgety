...
var controller = (function(budgetCtrl,UICtrl){
	var setUpEventListeners = function() {
		...
		document.querySelector(DOM.inputButton).addEventListener('click',cntlAddItem);
	...
	var updatePercentages = function(){
		...
		//update the percentages in the datastructure
		budgetCtrl.calculatePercentages();

		//read the new percentages from the budget controller
		var percentages = budgetCtrl.getPercentages();

		//display the new percentages in the UI
	...
	var cntlAddItem = function() {
		...
		if(input.description!=='' && !isNaN(input.value) && input.value > 0){
			//add the input data to the budget controller
